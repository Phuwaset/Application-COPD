...
<head>
    ...
    <title>appforthinkinnovation</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form>
            ...
            <h1 class="h5 mb-3 fw-normal">แอปพลิเคชันสำหรับนวัตกรรม</h1>

            <hr><br>

            <div class="form-floating">
                <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
                <label for="floatingInput">กรอกอีเมลล์</label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control" id="floatingPassword" placeholder="Password">
                <label for="floatingPassword">กรอกรหัสผ่าน</label>
            </div>

            <div class="form-check text-start my-3">
                <input class="form-check-input" type="checkbox" value="remember-me" id="flexCheckDefault">
                <label class="form-check-label" for="flexCheckDefault"> จดจำ </label>

            </div>
            <button class="btn btn-primary w-100 py-2" type="submit">เข้าสู่ระบบ</button>
            <p class="mt-5 mb-3 text-body-secondary">&copy; 2017–2023</p>
            <p>ยังไม่ได้ลงทะเบียนใช่หรือไม่ <a href="register.php">ลงทะเบียน</a></p>
        </form>
    </main>
